...
expName = 'EEG_Statistc'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Navigation_VR\\Social_Navigation_VR\\EEG_Statistc_lastrun.py',
...
# --- Initialize components for Routine "introrest" ---
text_4 = visual.TextStim(win=win, name='text_4',
    text='接下来是静息态扫描阶段，请你注视界面的+部分',
    font='Open Sans',
...
# --- Prepare to start Routine "introrest" ---
...
introrestComponents = [text_4, text_5, key_resp_5]
for thisComponent in introrestComponents:
...
print(20)
# the Routine "introrest" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
_key_resp_6_allKeys = []
# keep track of which components have finished
outroComponents = [text_6, key_resp_6]
