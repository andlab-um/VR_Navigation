/**************************** 
 * Vr_Memory_Test_Day2 Test *
 ****************************/


// store info about the experiment session:
let expName = 'VR_Memory_Test_Day2';  // from the Builder filename that created this script
let expInfo = {
...
flowScheduler.add(tr2_1RoutineBegin());
flowScheduler.add(tr2_1RoutineEachFrame());
flowScheduler.add(tr2_1RoutineEnd());
flowScheduler.add(intro2RoutineBegin());
flowScheduler.add(intro2RoutineEachFrame());
flowScheduler.add(intro2RoutineEnd());
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'ratepic_ESY.xlsx', 'path': 'ratepic_ESY.xlsx'},
    ...
    {'name': 'Arrange_ESY.xlsx', 'path': 'Arrange_ESY.xlsx'},
...
async function experimentInit() {
  ...
  excelnumber = Number.parseInt(expInfo["session"]);
  ...
  tr2_1Clock = new util.Clock();
  tmouse_2 = new core.Mouse({
    win: psychoJS.window,
  });
  tmouse_2.mouseClock = new util.Clock();
  // Run 'Begin Experiment' code from drg2
  count = 1;
  
  polygon_2 = new visual.Polygon({
    win: psychoJS.window, name: 'polygon_2', 
    edges: 100, size:[0.8, 0.8],
    ori: 0.0, pos: [0.04, 0],
    lineWidth: 5.0, 
    colorSpace: 'rgb',
  ...
  cmark = new visual.ImageStim({
    win : psychoJS.window,
    name : 'cmark', units : undefined, 
    image : undefined, mask : undefined,
  ...
  cmark2 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'cmark2', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [0.04, 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  cmark3 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'cmark3', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [0.04, 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  cmark4 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'cmark4', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [0.04, 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  cmark5 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'cmark5', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [0.04, 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  cmark6 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'cmark6', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [0.04, 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  btn_2.clock = new util.Clock();
  
  // Run 'Begin Experiment' code from code_3
  grid_size = 0.1;
  grid_r = 4;
  text_list = ["\u538b\u529b", "\u9ad8\u5524\u9192", "\u6fc0\u52a8", "\u4e0d\u6109\u5feb", "", "\u6109\u5feb", "\u538b\u6291", "\u4f4e\u5524\u9192", "\u653e\u677e"];
  text_components = [];
  text_pos_x = 0;
  text_pos_y = 0;
  for (var i, _pj_c = 0, _pj_a = util.range(9), _pj_b = _pj_a.length; (_pj_c < _pj_b); _pj_c += 1) {
      ...
      text_pos_y = ((Math.floor(((i / 3) - 1)) * grid_r) * (grid_size + 0.005));
      text_components.push(new visual.TextStim({"win": psychoJS.window, "text": text_list[i], "pos": [text_pos_x, text_pos_y], "height": 0.03}));
  }
  ...
  lmark1 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'lmark1', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [0.04, 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  lmark2 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'lmark2', units : undefined, 
    image : undefined, mask : undefined,
  ...
  lmark3 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'lmark3', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [(- 0.4), 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  lmark4 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'lmark4', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [(- 0.4), 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  lmark5 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'lmark5', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [(- 0.4), 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  lmark6 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'lmark6', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [(- 0.4), 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  lmark7 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'lmark7', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [(- 0.4), 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  lmark8 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'lmark8', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0.0, pos : [(- 0.4), 0], size : 1.0,
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
...
var clicked_stim;
var tr2_1Components;
function tr2_1RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'tr2_1' ---
    t = 0;
    tr2_1Clock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    ...
    psychoJS.experiment.addData("stage", "Preference");
    ...
    // keep track of which components have finished
    tr2_1Components = [];
    tr2_1Components.push(tmouse_2);
    tr2_1Components.push(polygon_2);
    tr2_1Components.push(image_7);
    tr2_1Components.push(cmark);
    tr2_1Components.push(cmark2);
    tr2_1Components.push(cmark3);
    tr2_1Components.push(cmark4);
    tr2_1Components.push(cmark5);
    tr2_1Components.push(cmark6);
    tr2_1Components.push(btn_2);
    
    tr2_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function tr2_1RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'tr2_1' ---
    // get current time
    t = tr2_1Clock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    // *tmouse_2* updates
    if (t >= 0.0 && tmouse_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      tmouse_2.tStart = t;  // (not accounting for frame time here)
      tmouse_2.frameNStart = frameN;  // exact frame index
      
      tmouse_2.status = PsychoJS.Status.STARTED;
      tmouse_2.mouseClock.reset();
      prevButtonState = [0, 0, 0];  // if now button is down we will treat as 'new' click
      }
    if (tmouse_2.status === PsychoJS.Status.STARTED) {  // only update if started and not finished!
      _mouseButtons = tmouse_2.getPressed();
      _mouseXYs = tmouse_2.getPos();
      tmouse_2.x.push(_mouseXYs[0]);
      tmouse_2.y.push(_mouseXYs[1]);
      tmouse_2.leftButton.push(_mouseButtons[0]);
      tmouse_2.midButton.push(_mouseButtons[1]);
      tmouse_2.rightButton.push(_mouseButtons[2]);
      tmouse_2.time.push(tmouse_2.mouseClock.getTime());
    }
    ...
    if ((tmouse_2.getPressed()[0] === 1)) {
        ...
        if (drg_in_process) {
            psychoJS.experiment.addData("item.x", tmouse_2.x);
            psychoJS.experiment.addData("item.y", tmouse_2.y);
            psychoJS.experiment.addData("item.time", tmouse_2.time);
            psychoJS.experiment.nextEntry();
        }
        drg_in_process = false;
    }
    ...
    // *cmark* updates
    if (t >= 0.0 && cmark.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      cmark.tStart = t;  // (not accounting for frame time here)
    ...
    // *cmark2* updates
    if (t >= 0.0 && cmark2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      cmark2.tStart = t;  // (not accounting for frame time here)
    ...
    // *cmark3* updates
    if (t >= 0.0 && cmark3.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      cmark3.tStart = t;  // (not accounting for frame time here)
    ...
    // *cmark4* updates
    if (t >= 0.0 && cmark4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      cmark4.tStart = t;  // (not accounting for frame time here)
    ...
    // *cmark5* updates
    if (t >= 0.0 && cmark5.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      cmark5.tStart = t;  // (not accounting for frame time here)
    ...
    // *cmark6* updates
    if (t >= 0.0 && cmark6.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      cmark6.tStart = t;  // (not accounting for frame time here)
    ...
    // *btn_2* updates
    if (t >= 0 && btn_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      btn_2.tStart = t;  // (not accounting for frame time here)
      btn_2.frameNStart = frameN;  // exact frame index
      
      btn_2.setAutoDraw(true);
    }

    if (btn_2.status === PsychoJS.Status.STARTED) {
      // check whether btn_2 has been pressed
      if (btn_2.isClicked) {
        if (!btn_2.wasClicked) {
          // store time of first click
          btn_2.timesOn.push(btn_2.clock.getTime());
          btn_2.numClicks += 1;
          // store time clicked until
          btn_2.timesOff.push(btn_2.clock.getTime());
        } else {
          // update time clicked until;
          btn_2.timesOff[btn_2.timesOff.length - 1] = btn_2.clock.getTime();
        }
        if (!btn_2.wasClicked) {
          continueRoutine = false;
        }
        // if btn_2 is still clicked next frame, it is not a new click
        btn_2.wasClicked = true;
      } else {
        // if btn_2 is clicked next frame, it is a new click
        btn_2.wasClicked = false;
      }
    } else {
      // keep clock at 0 if btn_2 hasn't started / has finished
      btn_2.clock.reset();
      // if btn_2 is clicked next frame, it is a new click
      btn_2.wasClicked = false;
    }
...
function tr2_1RoutineEnd(snapshot) {
  return async function () {
    ...
    // store data for psychoJS.experiment (ExperimentHandler)
    psychoJS.experiment.addData('tmouse_2.x', tmouse_2.x);
    psychoJS.experiment.addData('tmouse_2.y', tmouse_2.y);
    psychoJS.experiment.addData('tmouse_2.leftButton', tmouse_2.leftButton);
    psychoJS.experiment.addData('tmouse_2.midButton', tmouse_2.midButton);
    psychoJS.experiment.addData('tmouse_2.rightButton', tmouse_2.rightButton);
    psychoJS.experiment.addData('tmouse_2.time', tmouse_2.time);
    
    // Run 'End Routine' code from drg2
    //screenshot = psychoJS.window.getMovieFrame();
    ...
    psychoJS.experiment.addData('btn_2.numClicks', btn_2.numClicks);
    psychoJS.experiment.addData('btn_2.timesOn', btn_2.timesOn);
    psychoJS.experiment.addData('btn_2.timesOff', btn_2.timesOff);
...
function tr2RoutineBegin(snapshot) {
  return async function () {
    ...
    tr2Components.push(image_6);
    tr2Components.push(lmark1);
    tr2Components.push(lmark2);
    tr2Components.push(btn);
    tr2Components.push(lmark3);
    tr2Components.push(lmark4);
    tr2Components.push(lmark5);
    tr2Components.push(lmark6);
    tr2Components.push(lmark7);
    tr2Components.push(lmark8);
    
    tr2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function tr2RoutineEachFrame() {
  return async function () {
    ...
    // *lmark1* updates
    if (t >= 0.0 && lmark1.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lmark1.tStart = t;  // (not accounting for frame time here)
    ...
    // *lmark2* updates
    if (t >= 0.0 && lmark2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lmark2.tStart = t;  // (not accounting for frame time here)
    ...
    // *lmark3* updates
    if (t >= 0.0 && lmark3.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lmark3.tStart = t;  // (not accounting for frame time here)
    ...
    // *lmark4* updates
    if (t >= 0.0 && lmark4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lmark4.tStart = t;  // (not accounting for frame time here)
    ...
    // *lmark5* updates
    if (t >= 0.0 && lmark5.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lmark5.tStart = t;  // (not accounting for frame time here)
    ...
    // *lmark6* updates
    if (t >= 0.0 && lmark6.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lmark6.tStart = t;  // (not accounting for frame time here)
    ...
    // *lmark7* updates
    if (t >= 0.0 && lmark7.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lmark7.tStart = t;  // (not accounting for frame time here)
    ...
    // *lmark8* updates
    if (t >= 0.0 && lmark8.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lmark8.tStart = t;  // (not accounting for frame time here)
...
function tr3RoutineBegin(snapshot) {
  return async function () {
    ...
    tr3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function tr3RoutineEnd(snapshot) {
  return async function () {
    ...
    //screenshot = psychoJS.window.getMovieFrame();
    //screenshot.save((((("d2data/" + expInfo["participant"]) + "_") + pictype.toString()) + "_arrangement.png"));
    //psychoJS.window.clearBuffer();
    //
