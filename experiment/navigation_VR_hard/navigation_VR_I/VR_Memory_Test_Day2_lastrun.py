...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Navigation_VR\\Social_Navigation_VR\\navigation_VR_hard\\navigation_VR_I\\VR_Memory_Test_Day2_lastrun.py',
...
thisExp.addData('tmouse_2.x', tmouse_2.x)
thisExp.addData('tmouse_2.y', tmouse_2.y)
thisExp.addData('tmouse_2.leftButton', tmouse_2.leftButton)
thisExp.addData('tmouse_2.midButton', tmouse_2.midButton)
thisExp.addData('tmouse_2.rightButton', tmouse_2.rightButton)
thisExp.addData('tmouse_2.time', tmouse_2.time)
thisExp.nextEntry()
...
thisExp.nextEntry()
thisExp.addData('btn_2.numClicks', btn_2.numClicks)
if btn_2.numClicks:
   thisExp.addData('btn_2.timesOn', btn_2.timesOn)
   thisExp.addData('btn_2.timesOff', btn_2.timesOff)
else:
   thisExp.addData('btn_2.timesOn', "")
   thisExp.addData('btn_2.timesOff', "")
...
trials_2 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Arrange.xlsx'),
