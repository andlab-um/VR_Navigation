...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Navigation_VR\\Social_Navigation_VR\\VR_Memory_Test_Test_lastrun.py',
...
if expInfo['version'] == 'ESY':
    w_file = 'orderexcel_ESY/' + str(excelnumber) + '.xlsx'
...
for thisTrial_2 in trials_2:
    ...
    label14.setImage(t8)
    # keep track of which components have finished
    trialpComponents = [image_3, mouse, scene, label1, label2, label3, label4, label5, label6, label7, label8, label9, label10, startpoint, endpoint, label11, label12, label13, label14, button]
